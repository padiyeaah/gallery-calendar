              ...
              <div class="iq-navbar-custom">
                  <div class="d-flex align-items-center justify-content-between">
                      <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                          ...
                          <a href="index.html" class="header-logo d-flex justify-content-center align-items-center m-0">
                            {{-- <span>Diaryku</span> --}}
                                  ...
                                  <li class="caption-content">
                                      <a href="#" class="search-toggle dropdown-toggle d-flex align-items-center" id="dropdownMenuButton3" data-toggle="dropdown"
                                          ...
                                          <div class="caption ml-3">
                                              <h6 class="mb-0 line-height">Padiyah<i class="las la-angle-down ml-3"></i></h6>
                                          </div>
                                      </a>
                                      <div class="iq-sub-dropdown dropdown-menu user-dropdown" aria-labelledby="dropdownMenuButton3">
                                          <div class="card m-0">
                                              <div class="card-body p-0">
                                                  <div class="py-3">
                                                      <a href="https://templates.iqonic.design/calendify/html/app/user-profile.html" class="iq-sub-card">
                                    ...
                                    <div class="card-body rounded event-detail event-detail-danger disabled">
                                        <div class="d-flex align-items-top justify-content-between">
                                                ...
                                                <div class="card-header-toolbar mt-1">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            {{-- @endif --}}
                                                            {{-- @if ($moment->user_id === Auth::id()) --}}
                                                                <a class="dropdown-item edit-moment-btn"
                                                                    href="#"
                                                                    data-momentid="//"
                                                                    data-toggle="modal"
                                                                    data-target="//">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <p class="mb-3 card-description text-left">Diaryku always allows you to set the reminder to optimize task management roles and jobs.</p>
